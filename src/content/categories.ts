...
export const CATEGORIES: Category[] = [
  {
    ...
    items: [
      ...
      { id: "sound", title: "Sound Settings", subtitle: "Coming in v2", icon: "/icons/Icons.34.png", kind: "setting", status: "disabled" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "safetywing", title: "SafetyWing", subtitle: "Insurance · 2023", meta: "Nomad-first health coverage", icon: "/icons/Icons.8.png", kind: "case-study", href: "/case-studies/safetywing", status: "live" },
    ],
  },
  {
    id: "projects",
